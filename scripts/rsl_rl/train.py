...
parser.add_argument(
    "--resume_checkpoint", type=str, default=None, help="Path to checkpoint file to load (bypasses run name resolution)."
)
parser.add_argument(
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    if args_cli.resume_checkpoint is not None:
        # use arbitrary checkpoint path if provided
        resume_path = args_cli.resume_checkpoint
        print(f"[INFO]: Using checkpoint path from --resume_checkpoint argument: {resume_path}")
