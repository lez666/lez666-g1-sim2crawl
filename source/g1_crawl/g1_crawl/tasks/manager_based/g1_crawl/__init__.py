...
#     disable_env_checker=True,
#     kwargs={
#         "env_cfg_entry_point": f"{__name__}.g1_crawl2shamble_env_cfg:G1Crawl2ShambleEnvCfg",
#         "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:PPORunnerCfg",
#     },
# )
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.g1_crawl_start_env_cfg:G1CrawlStartEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:PPORunnerCfg",
    },
)
...
#     disable_env_checker=True,
#     kwargs={
#         "env_cfg_entry_point": f"{__name__}.g1_crawl_proc_env_cfg_rough:G1CrawlProcEnvCfg",
#         "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:PPORunnerCfg",
#     },
# )
