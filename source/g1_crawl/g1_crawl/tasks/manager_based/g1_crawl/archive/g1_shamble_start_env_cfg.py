...
@configclass
class G1ShambleStartSceneCfg(InteractiveSceneCfg):
  # ground terrain
...
class EventCfg:
    ...
    #         "frame_range": (0,1000),  # Start with last pose only - curriculum will expand backward
...
class G1ShambleStartEnvCfg(ManagerBasedRLEnvCfg):
    # Scene settings
    scene: G1ShambleStartSceneCfg = G1ShambleStartSceneCfg(num_envs=4096, env_spacing=4.0)
